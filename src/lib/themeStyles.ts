...
export const THEMES: Record<ThemeStyle, ThemeConfig> = {
  ...
  minimalist: {
    id: 'minimalist',
    name: 'Escuro Minimalista',
    description: 'Estilo elegante, sutil e com fontes limpas, reduzindo o cansaço visual.',
    fontDisplay: 'font-sans font-medium tracking-tight',
    fontBody: 'font-sans',
    fontMono: 'font-mono text-zinc-400',
    bgGlobal: 'bg-[#09090C]',
    bgCard: 'bg-[#121214]',
    bgPanel: 'bg-[#18181B]',
    bgAccent: 'bg-[#27272A]/30',
    cardPattern: 'bg-dots-pattern',
    opacityPattern: 'opacity-5',
    ...
    textMuted: 'text-zinc-500',
    textPrimaryAccent: 'text-zinc-100',
    borderColor: 'border-zinc-800',
    borderAccent: 'border-zinc-700',
    borderThickClass: 'border-l-2 border-zinc-500',
    roundedSlide: 'rounded-lg shadow',
    roundedCard: 'rounded-lg border border-zinc-800',
    skewAngle: 'skew-x-0',
    unskewAngle: 'skew-x-0',
    btnPrimaryBg: 'bg-zinc-100',
    btnPrimaryText: 'text-zinc-950 font-semibold',
    btnPrimaryHover: 'hover:bg-zinc-200',
    btnSecondaryBg: 'bg-[#18181B]',
    btnSecondaryText: 'text-zinc-350',
    btnSecondaryHover: 'hover:bg-zinc-800',
    shadowGlow: 'shadow-md shadow-black/80',
    shadowGlowHeavy: 'shadow-xl shadow-black',
    progressBg: 'bg-zinc-200',
    progressTrack: 'bg-zinc-850'
  }
};
